    ...
    public unsafe class LevelExp
    {
        ...
        public void LoadFromDat(String Path)
        {
            ...
            lock (Entries)
            {
                using (FileStream Stream = new FileStream(Path, FileMode.Open, FileAccess.Read, FileShare.Read))
                {
                    ...
                    while (Read > 0)
                    {
                        Int32 NewLen = Entries.Length + Read / 4;
                        Int32[] Temp = new Int32[NewLen];
        ...
        public Boolean Add(Int32 Level, Int32 Exp)
        {
            ...
            lock (Entries)
            {
                ...
                Int32[] temp = new Int32[Entries.Length + 1];
